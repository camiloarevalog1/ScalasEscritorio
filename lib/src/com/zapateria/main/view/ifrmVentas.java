...
public class ifrmVentas extends MarcoInternoPersonalizado {
    ...
    private void initComponents() {
        ...
        btnAceptar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/zapateria/main/images/guardarCli.png"))); // NOI18N
        ...
        gridBagConstraints.ipadx = -31;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 6, 7, 18);
        panelCliente.add(btnAceptar, gridBagConstraints);
        ...
        panelFactura.setPreferredSize(new java.awt.Dimension(898, 107));
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(27, 4, 0, 0);
        panelFactura.add(lbBuscarFactura, gridBagConstraints);
        ...
        panelPagosLayout.setHorizontalGroup(
            ...
            .addGroup(panelPagosLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(spPagos, javax.swing.GroupLayout.DEFAULT_SIZE, 1153, Short.MAX_VALUE)
                .addGap(10, 10, 10)
        ...
        panelPagosLayout.setVerticalGroup(
            ...
            .addGroup(panelPagosLayout.createSequentialGroup()
                ...
                .addGroup(panelPagosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(spPagos, javax.swing.GroupLayout.DEFAULT_SIZE, 555, Short.MAX_VALUE))
                .addGap(10, 10, 10))
        );
        ...
        btnNuevoImpuesto.setText("Nuevo");
        ...
        btnEliminarImpuesto.setText("Eliminar");
        ...
        panelImpuestosLayout.setHorizontalGroup(
            ...
            .addGroup(panelImpuestosLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(spImpuestos, javax.swing.GroupLayout.DEFAULT_SIZE, 1153, Short.MAX_VALUE)
                .addGap(10, 10, 10)
                .addGroup(panelImpuestosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnEliminarImpuesto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnNuevoImpuesto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10))
        );
            ...
            .addGroup(panelImpuestosLayout.createSequentialGroup()
                ...
                .addGroup(panelImpuestosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelImpuestosLayout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(btnEliminarImpuesto))
                    .addComponent(spImpuestos, javax.swing.GroupLayout.DEFAULT_SIZE, 555, Short.MAX_VALUE))
                .addGap(10, 10, 10))
        );
        ...
        panelProductosLayout.setHorizontalGroup(
            ...
            .addGroup(panelProductosLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(spProductos, javax.swing.GroupLayout.DEFAULT_SIZE, 1153, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panelProductosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnEliminarProducto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnNuevoProducto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        panelProductosLayout.setVerticalGroup(
            ...
            .addGroup(panelProductosLayout.createSequentialGroup()
                ...
                .addGroup(panelProductosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(spProductos, javax.swing.GroupLayout.DEFAULT_SIZE, 555, Short.MAX_VALUE))
                .addGap(10, 10, 10))
        );
    ...
    private void llenarTablaProductos() {
        ...
        final String[] columnas = {"Id", "Nombre", "Precio unitario"};
...
//        tbVentas.getTableHeader().setBackground(Color.cyan);
        ...
        tbVentas.getColumnModel().getColumn(0).setMaxWidth(30);
        tbVentas.getColumnModel().getColumn(1).setMaxWidth(80);
        tbVentas.getColumnModel().getColumn(2).setMaxWidth(80);
        tbVentas.getColumnModel().getColumn(3).setMaxWidth(300);
...
//        aplicarEventosPersonalizados(tbVentas);
    ...
    private void llenarTablaImpuestos() {
        ...
        final String[] columnas = {"Id", "Nombre", "Valor"};
    ...
    private void llenarTablaPagos() {
        ...
        final String[] columnas = {"Id", "Factura", "Abono", "Fecha"};
        ...
        dtbmPagos.addTableModelListener((TableModelEvent e) -> {
            ...
            if (e.getType() == TableModelEvent.UPDATE) {
                ...
                if (objId != null) {
                    ...
                    if (servicio.editarPago(id, abono, factura)) {
...
//        }
    ...
    private boolean registrarVentas() {
        ...
        for (int i = 0; i < tbVentas.getRowCount(); i++) {
            ...
            idFactura = Long.parseLong(textNumeroFactura.getText());
            ...
            if (!servicio.registrarVenta(cantidad, comentario, idFactura, producto.getId())) {
                return false;
            }
        }
        return true;
    ...
    private void btnEliminarPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarPagoActionPerformed
        if (panelPagos.isShowing()) {
            ...
            if (servicio.eliminarPago(id)) {
                ...
                mostrarMensaje("No se pudo eliminar el pago");
            }
        }
