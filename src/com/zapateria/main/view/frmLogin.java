...
public class frmLogin extends javax.swing.JFrame {
     ...
     */
//    Image icon = new ImageIcon(getClass().getResource("src\\com\\zapateria\\main\\images\\icon.png")).getImage();
    public frmLogin() {
        initComponents();
        //Línea 1
    ...
    private void iniciarSesion() {
        ...
        boolean x=Sesion.iniciarSesion(usuario, contrasena);
