...
public class CompraDTO implements java.io.Serializable {
    ...
    private double valorUnitario, valorTotal, abonado;
...
DecimalFormat formateador = new DecimalFormat("###,###.###");
    ...
    public CompraDTO(long id, long cantidad, double valorUnitario,
            double valorTotal, Timestamp fecha, long proveedor, long material, double abonado) {
        this.id = id;
        this.cantidad = cantidad;
        this.valorUnitario = valorUnitario;
        this.valorTotal = valorTotal;
    ...
    public Object[] toArray() {
        return new Object[]{
            this.id,
            this.cantidad,
            formateador.format(this.valorUnitario),
            formateador.format(this.valorTotal),
            this.fecha,
            this.proveedorDTO,
            this.matrialDTO,
